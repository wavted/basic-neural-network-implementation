...
training_data = list(zip(training_data[0].reshape((len(training_data[0]), 784, 1)), to_categorical(training_data[1], 10)))
test = list(zip(test_data[0].reshape((len(test_data[0]), 784, 1)), test_data[1]))
